...
static const ARMCPRegInfo gicv3_cpuif_reginfo[] = {
    ...
    { .name = "ICC_HSRE", .state = ARM_CP_STATE_AA32,
...
static const ARMCPRegInfo gicv3_cpuif_hcr_reginfo[] = {
...
#ifdef HPSC
    { .name = "ICH_AP0R0", .state = ARM_CP_STATE_AA32,
    ...
    { .name = "ICH_AP1R0", .state = ARM_CP_STATE_AA32,
    ...
    { .name = "ICH_HCR", .state = ARM_CP_STATE_AA32,
    ...
    { .name = "ICH_VTR", .state = ARM_CP_STATE_AA32,
      .cp = 15, .opc1 = 4, .crn = 12, .crm = 11, .opc2 = 1,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_R,
      .readfn = ich_vtr_read,
    },
    { .name = "ICH_MISR", .state = ARM_CP_STATE_AA32,
      .cp = 15, .opc1 = 4, .crn = 12, .crm = 11, .opc2 = 2,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_R,
      .readfn = ich_misr_read,
    },
    { .name = "ICH_EISR", .state = ARM_CP_STATE_AA32,
      .cp = 15, .opc1 = 4, .crn = 12, .crm = 11, .opc2 = 3,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_R,
      .readfn = ich_eisr_read,
    },
    { .name = "ICH_ELRSR", .state = ARM_CP_STATE_AA32,
      .cp = 15, .opc1 = 4, .crn = 12, .crm = 11, .opc2 = 5,
      .type = ARM_CP_IO | ARM_CP_NO_RAW,
      .access = PL2_R,
      .readfn = ich_elrsr_read,
    },
    { .name = "ICH_VMCR", .state = ARM_CP_STATE_AA32,
